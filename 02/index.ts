...
const filtrarNomes = (lista:{nome:string, idade:number, status:boolean}[], nome:string):{}[] => {
    const resultados: {nome:string, idade:number, status: boolean}[] = [];
...
console.log( filtrarNomes(usuarios,'a') )